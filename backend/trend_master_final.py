...
# --- TREND MASTER v30.0 FINAL VALIDATION ---
def get_hot_symbols():
...
def run_simulation(df):
    ...
    for i in range(100, len(df)):
        ...
        # TREND VETO (v30.0)
        if side == "buy" and row['c'] < row['ema_200']: continue
        if side == "sell" and row['c'] > row['ema_200']: continue
...
def main():
    print("\n" + "="*85)
    print("TREND MASTER v30.0: THE ULTIMATE WIN PATTERN VALIDATION")
    print("="*85)
